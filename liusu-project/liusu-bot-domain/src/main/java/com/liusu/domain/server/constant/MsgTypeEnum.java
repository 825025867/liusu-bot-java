...
public enum MsgTypeEnum {
  ...
  /** @ 群成员的消息[G] */
  AT_MSG(7, "AtMsg", "at成员消息"),
  /** 大表情消息[FG] */
  BIG_FACE_MSG(8, "BigFaceMsg", "大表情消息"),
  /** 红包消息(只在红包发出的时候会收到此消息) */
  RED_BAG_MSG(9, "RedBagMsg", "红包消息"),
  /** JSON消息 */
  JSON_MSG(10, "JsonMsg", "JSON消息"),
  /** 群文件消息 */
  GROUP_FILE_MSG(11, "GroupFileMsg", "群文件消息"),
  /** 临时会话消息 */
  TEMP_SESSION_MSG(12, "TempSessionMsg", "临时会话消息"),
  /** 短视频消息 */
  VIDEO_MSG(13, "VideoMsg", "短视频消息"),
  /** 其他消息 */
  UNKNOWN_MSG(99, "UnknownMsg", "其他消息");
  ...
  private MsgTypeEnum(int value, String code, String name) {
    this.value = value;
    this.code = code;
    this.name = name;
  }
