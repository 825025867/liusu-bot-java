...
package com.liusu.listener.server;
...
import com.liusu.listener.server.bot.service.ListenerBotService;
...
public class ListenerWebApplication {

  public static void main(String[] args) {
    SpringApplication.run(ListenerWebApplication.class, args);
  }
  ...
  class ApplicationRunner implements CommandLineRunner {
    ...
    @Autowired
    ListenerBotService service;

    @Override
    public void run(String... args) throws Exception {
      service.startListenerBot();
      if (logger.isDebugEnabled()) {
        logger.debug("---------LiuSuBot----ListenerBootWeb Application 启动完成-----------");
      }
    }
  }
