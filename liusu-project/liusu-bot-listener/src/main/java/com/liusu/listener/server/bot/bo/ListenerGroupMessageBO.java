 ...
 * @since 2021.01.27
 */
public class ListenerGroupMessageBO extends ListenerMessageBaseBO {

  private static final long serialVersionUID = 7451921556125628094L;
  ...
  public String toString() {
    return "ListenerGroupMessageBO [groupId=" + groupId + ", groupNickName=" + groupNickName + ", senderNickName="
        ...
        + ", tips=" + tips + ", bigFace=" + bigFace + ", video=" + video + ", voiceUrl=" + voiceUrl + ", senderId="
        + senderId + ", receiveId=" + receiveId + ", message=" + message + ", messageType=" + messageType + "]";
  }
